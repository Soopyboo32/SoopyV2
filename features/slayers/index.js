...
class Slayers extends Feature {
	...
	onEnable() {
		...
		this.betterHideDeadEntity = new ToggleSetting("Also hides mob nametag when it's dead.", "An improvement for Patcher's hide dead entity", true, "hide_dead_mob_nametag", this);
