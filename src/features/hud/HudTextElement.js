...
class HudTextElement {
    ...
    setLocation(x = this.locationSetting.x, y = this.locationSetting.y, scale = this.locationSetting.scale) {
        this.locationSetting.x = x
        this.locationSetting.y = y
        this.locationSetting.scale = scale
